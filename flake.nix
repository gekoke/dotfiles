        ...
        nixosConfigurations =
          let
            ...
            commonModules = [
              ...
              (importApply ./modules/nixos/stylix/stylesheets/main { inherit elementaryPackages; })
              (importApply ./v3/modules/nixos/emacs/default.nix {
                inherit (inputs) emacs-lsp-booster;
                inherit elementaryPackages;
              })
