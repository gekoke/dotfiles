  ...
  config = mkIf cfg.enable {
    ...
    plusultra.home.programs.rofi = {
      ...
      theme = mkIf cfg.rofi-collection.enable
        "${inputs.rofi-collection}/files/launchers/type-${toString cfg.rofi-collection.type}/style-${toString cfg.rofi-collection.style}.rasi";
    };
    ...
    plusultra.desktop.hyprland.extraHomeManagerOptions.extraConfig = ''
      ...
      bind = SUPER SHIFT, P, exec, pkill rofi || rofi -show window
    '';
  };
}
